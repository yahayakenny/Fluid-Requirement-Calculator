...
function totalFluidIntake() {
  ...
  var twoThird = Math.floor(total * 0.667)
    var finalString = "You should give the child " +total+ "mls over a 24hr period divided as " + third.toString() + "mls over the first 8hrs and " + twoThird + "mls over the following 16hrs."
